...
namespace dnSpy.Decompiler.ILSpy.Core.Settings {
	class DecompilerSettingsManager {
		/// <summary>
		/// Should only be used indirectly by dnSpy.Console.exe
		/// </summary>
		public static DecompilerSettingsManager __Instance_DONT_USE {
			get {
				if (__instance_DONT_USE == null)
					Interlocked.CompareExchange(ref __instance_DONT_USE, new DecompilerSettingsManager(), null);
				return __instance_DONT_USE;
			}
		}
		static DecompilerSettingsManager __instance_DONT_USE;

		protected DecompilerSettingsManager() {
