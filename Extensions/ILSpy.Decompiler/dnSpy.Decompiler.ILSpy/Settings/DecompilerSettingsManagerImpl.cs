...
namespace dnSpy.Decompiler.ILSpy.Settings {
	[Export(typeof(DecompilerSettingsManager))]
	sealed class DecompilerSettingsManagerImpl : DecompilerSettingsManager {
		[ImportingConstructor]
		DecompilerSettingsManagerImpl(DecompilerSettingsImpl decompilerSettings, ILSettingsImpl ilSettings) {
