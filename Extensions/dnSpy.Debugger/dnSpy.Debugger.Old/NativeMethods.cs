...
namespace dnSpy.Debugger {
	static class NativeMethods {
		...
		[DllImport("kernel32", SetLastError = true, EntryPoint = "OpenProcess")]
		public static extern IntPtr OpenProcess2(uint dwDesiredAccess, bool bInheritHandle, uint dwProcessId);
	}
}
