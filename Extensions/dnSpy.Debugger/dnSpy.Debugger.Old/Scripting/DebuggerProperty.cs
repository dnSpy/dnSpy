...
namespace dnSpy.Debugger.Scripting {
	sealed class DebuggerProperty : IDebuggerProperty {
		...
		public void Write(IOutputWriter output, TypeFormatFlags flags) =>
			debugger.Dispatcher.UI(() => prop.Write(new OutputWriterConverter(output), (TypeFormatterFlags)flags));
		public string ToString(TypeFormatFlags flags) => debugger.Dispatcher.UI(() => prop.ToString((TypeFormatterFlags)flags));
