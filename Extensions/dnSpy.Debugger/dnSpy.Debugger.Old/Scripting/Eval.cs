...
namespace dnSpy.Debugger.Scripting {
	sealed class Eval : IEval {
		...
		public IDebuggerValue CreateBox(bool value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue CreateBox(char value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue CreateBox(sbyte value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue CreateBox(byte value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue CreateBox(short value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue CreateBox(ushort value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue CreateBox(int value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue CreateBox(uint value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue CreateBox(long value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue CreateBox(ulong value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue CreateBox(float value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue CreateBox(double value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue CreateBox(IntPtr value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue CreateBox(UIntPtr value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue CreateBox(decimal value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue CreateBox(Type type) => debugger.Dispatcher.UI(() => CreateNoConstructorUI(FindTypeThrow(type)));
		...
		public IDebuggerValue CreateNull() => debugger.Dispatcher.UI(() => Create(eval.CreateNull()));
		...
		public IDebuggerValue Create(bool value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue Create(char value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue Create(sbyte value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue Create(byte value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue Create(short value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue Create(ushort value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue Create(int value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue Create(uint value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue Create(long value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue Create(ulong value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue Create(float value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue Create(double value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue Create(IntPtr value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue Create(UIntPtr value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue Create(decimal value) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue CreateArray(Type elementType, int length) => debugger.Dispatcher.UI(() => CreateArray(FindTypeThrow(elementType), length));

		public unsafe IDebuggerValue Create(bool[] array) => debugger.Dispatcher.UI(() => {
		...
		public unsafe IDebuggerValue Create(char[] array) => debugger.Dispatcher.UI(() => {
		...
		public unsafe IDebuggerValue Create(sbyte[] array) => debugger.Dispatcher.UI(() => {
		...
		public unsafe IDebuggerValue Create(byte[] array) => debugger.Dispatcher.UI(() => {
		...
		public unsafe IDebuggerValue Create(short[] array) => debugger.Dispatcher.UI(() => {
		...
		public unsafe IDebuggerValue Create(ushort[] array) => debugger.Dispatcher.UI(() => {
		...
		public unsafe IDebuggerValue Create(int[] array) => debugger.Dispatcher.UI(() => {
		...
		public unsafe IDebuggerValue Create(uint[] array) => debugger.Dispatcher.UI(() => {
		...
		public unsafe IDebuggerValue Create(long[] array) => debugger.Dispatcher.UI(() => {
		...
		public unsafe IDebuggerValue Create(ulong[] array) => debugger.Dispatcher.UI(() => {
		...
		public unsafe IDebuggerValue Create(float[] array) => debugger.Dispatcher.UI(() => {
		...
		public unsafe IDebuggerValue Create(double[] array) => debugger.Dispatcher.UI(() => {
		...
		public unsafe IDebuggerValue Create(string[] array) => debugger.Dispatcher.UI(() => {
		...
		public IDebuggerValue Create(Type type) => debugger.Dispatcher.UI(() => Create(FindTypeThrow(type)));
		...
		public IDebuggerValue Create(IDebuggerMethod ctor, params object[] args) => debugger.Dispatcher.UI(() => eval.CallConstructor(((DebuggerMethod)ctor).CorFunction, CreateArgs(args)).ToDebuggerValue(debugger));
		...
		public IDebuggerValue AssemblyLoad(byte[] rawAssembly) => debugger.Dispatcher.UI(() => Call(FindAssemblyLoadByteArrayThrow(), rawAssembly));
		public IDebuggerValue AssemblyLoad(string assemblyString) => debugger.Dispatcher.UI(() => Call(FindAssemblyLoadStringThrow(), assemblyString));
