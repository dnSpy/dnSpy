...
namespace dnSpy.Debugger.Scripting {
	sealed class DebuggerType : IDebuggerType {
		...
		public void Write(IOutputWriter output, TypeFormatFlags flags) =>
			debugger.Dispatcher.UI(() => type.Write(new OutputWriterConverter(output), (TypeFormatterFlags)flags));
		public string ToString(TypeFormatFlags flags) => debugger.Dispatcher.UI(() => type.ToString((TypeFormatterFlags)flags));
