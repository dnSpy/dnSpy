...
#pragma warning disable 1591 // Missing XML comment for publicly visible type or member
		public static bool operator ==(DmdPropertyInfo left, DmdPropertyInfo right) => DmdMemberInfoEqualityComparer.Default.Equals(left, right);
		public static bool operator !=(DmdPropertyInfo left, DmdPropertyInfo right) => !DmdMemberInfoEqualityComparer.Default.Equals(left, right);
#pragma warning restore 1591 // Missing XML comment for publicly visible type or member
		...
		/// <returns></returns>
		public bool Equals(DmdPropertyInfo other) => DmdMemberInfoEqualityComparer.Default.Equals(this, other);
