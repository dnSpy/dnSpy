...
namespace dnSpy.Debugger.DotNet.Metadata.Impl.MD {
	sealed class DmdExportedTypeMD : DmdTypeRef {
		...
		public override DmdType WithCustomModifiers(IList<DmdCustomModifier> customModifiers) => AppDomain.Intern(new DmdExportedTypeMD(reader, Rid, customModifiers));
		public override DmdType WithoutCustomModifiers() => GetCustomModifiers().Count == 0 ? this : AppDomain.Intern(new DmdExportedTypeMD(reader, Rid, null));
	}
}
