...
namespace dnSpy.Debugger.DotNet.Metadata.Impl.MD {
	sealed class DmdConstructorDefMD : DmdConstructorDef {
		...
		public DmdConstructorDefMD(DmdEcma335MetadataReader reader, RawMethodRow row, uint rid, string name, DmdType declaringType, DmdType reflectedType, IList<DmdType> genericTypeArguments) : base(rid, declaringType, reflectedType) {
