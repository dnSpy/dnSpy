...
namespace dnSpy.Debugger.Impl {
	sealed class DbgEngineBoundCodeBreakpointImpl : DbgEngineBoundCodeBreakpoint {
		...
		public override void Update(UpdateOptions options, DbgModule module, ulong address, DbgEngineBoundCodeBreakpointMessage message) => boundCodeBreakpoint.Process.DbgManager.DispatcherThread.BeginInvoke(() => {
