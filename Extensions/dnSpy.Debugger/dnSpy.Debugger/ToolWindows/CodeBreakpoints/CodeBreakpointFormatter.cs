...
namespace dnSpy.Debugger.ToolWindows.CodeBreakpoints {
	...
	sealed class CodeBreakpointFormatter {
		...
		internal void WriteHitCount(ITextColorWriter output, CodeBreakpointVM vm) => vm.Context.BreakpointConditionsFormatter.Write(output, vm.CodeBreakpoint.HitCount, vm.Context.DbgCodeBreakpointHitCountService.GetHitCountIfDebugging(vm.CodeBreakpoint));
