...
namespace dnSpy.AsmEditor.Hex.Nodes {
	[ExportReferenceFileTabContentProvider(Order = TabConstants.ORDER_CONTENTPROVIDER_HEXTOKENREF)]
	sealed class TokenReferenceFileTabContentProvider : IReferenceFileTabContentProvider {
