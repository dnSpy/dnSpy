...
namespace ICSharpCode.ILSpy.dntheme
{
	public enum ColorType
	{
		...
		ToolBarComboBoxToggleButtonBorder,
		ToolBarComboBoxTransparentButtonFill,
		CheckBoxFillNormal,
		CheckBoxStroke,
		CommonCheckMarkStroke,
		CommonCheckMarkPressedStroke,
		CommonRadioButtonDisabledGlyphStroke,
		CommonRadioButtonGlyphStroke,
		CommonCheckMarkDisabledFill,
		CommonCheckMarkFill,
		CommonCheckMarkPressedFill,
		CommonRadioButtonGlyphDisabledFill,
		CommonRadioButtonGlyphFill,
		CommonRadioButtonGlyphHoverFill,
		CommonRadioButtonGlyphPressedFill,
		CommonHoverBackgroundOverlay,
		CommonPressedBackgroundOverlay,
		CommonDisabledBackgroundOverlay,
		CommonHoverBorderOverlay,
		CommonPressedBorderOverlay,
		CommonDisabledBorderOverlay,
		CommonCheckBoxDisabledInnerBorderPen,
		CommonCheckBoxInnerBorderPen,
		CommonCheckBoxHoverInnerBorderPen,
		CommonCheckBoxPressedInnerBorderPen,
		CommonIndeterminateDisabledInnerBorderPen,
		CommonIndeterminateInnerBorderPen,
		CommonIndeterminateHoverInnerBorderPen,
		CommonIndeterminatePressedInnerBorderPen,
		CommonRadioButtonInnerBorderPen,
		CommonRadioButtonHoverInnerBorderPen,
		CommonRadioButtonPressedInnerBorderPen,
		CommonCheckBoxInnerFill,
		CommonCheckBoxHoverInnerFill,
		CommonCheckBoxPressedInnerFill,
		CommonIndeterminateDisabledFill,
		CommonIndeterminateFill,
		CommonIndeterminateHoverFill,
		CommonIndeterminatePressedFill,
		RadioButtonBackground,
		ButtonIconBackground,
		ButtonNormalBackground,
		ButtonNormalBorder,
		ButtonBaseDisabledForeground,
		ButtonBaseCommonPressedBackgroundOverlay,
		ButtonBaseCommonHoverBackgroundOverlay,
		ButtonBaseCommonInnerBorder,
		ButtonBaseBorderOverlayBorder,
		ButtonBaseDisabledBorderBrush,
		ButtonBaseDisabledBorderOverlayBackground,
		ButtonBaseMouseOverBorderBrush,
		ButtonBasePressedBorderOverlayBrush,
		ButtonBaseDefaultedBorderOverlayBrush,
		...
		ProgressBarTopHighlight,
		ProgressBarGlassyHighlight,
		ProgressBarIndicatorGlassyHighlight,
		ProgressBarIndicatorLightingEffectLeft,
		ProgressBarIndicatorLightingEffect,
		ProgressBarIndicatorLightingEffectRight,
		ProgressBarIndicatorDarkEdgeLeft,
		ProgressBarIndicatorDarkEdgeRight,
		ProgressBarIndicatorAnimatedFill,
		ProgressBarBorderBrush2,
		ProgressBarIndeterminateBackground,
		ResizeGripperForeground,
		ScrollBarDisabledBackground,
		ScrollBarBackground,
		ScrollBarArrowButtonForeground,
		ScrollBarArrowButtonDisabled,
		ScrollBarArrowButtonMouseOverBackground,
		ScrollBarArrowButtonPressed,
		ScrollBarThumbBackground,
		ScrollBarThumbBorder,
		ScrollBarThumbDisabledBackground,
		ScrollBarThumbDisabledBorder,
		ScrollBarThumbMouseOverBackground,
		ScrollBarThumbMouseOverBorder,
		ScrollBarThumbPressedBackground,
		ScrollBarThumbPressedBorder,
		StatusBar,
		TextBoxBorder,
		TextBoxHoverBorder,
