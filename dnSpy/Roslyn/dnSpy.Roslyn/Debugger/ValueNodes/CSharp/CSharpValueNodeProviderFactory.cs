...
namespace dnSpy.Roslyn.Debugger.ValueNodes.CSharp {
	sealed class CSharpValueNodeProviderFactory : DbgDotNetValueNodeProviderFactory {
		...
		readonly DbgDotNetText staticMembersName = new DbgDotNetText(new DbgDotNetTextPart(BoxedTextColor.Text, dnSpy_Roslyn_Resources.DebuggerVarsWindow_CSharp_StaticMembers));
