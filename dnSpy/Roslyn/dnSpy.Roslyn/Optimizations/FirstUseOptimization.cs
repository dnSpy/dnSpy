...
using dnSpy.Roslyn.Intellisense.Completions;
using dnSpy.Roslyn.Intellisense.QuickInfo;
using dnSpy.Roslyn.Intellisense.SignatureHelp;
using dnSpy.Roslyn.Internal.SignatureHelp;
using dnSpy.Roslyn.Text;
using dnSpy.Roslyn.Text.Tagging;
...
namespace dnSpy.Roslyn.Optimizations {
	[ExportAutoLoaded]
