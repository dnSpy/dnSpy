...
namespace dnSpy.Roslyn.Shared.Text.Classification {
	...
	/// </summary>
	public sealed class RoslynClassificationTypes2 {
...
#pragma warning restore 0618 // Type or member is obsolete
		...
		/// </summary>
		public static readonly RoslynClassificationTypes2 Default = new RoslynClassificationTypes2();

		RoslynClassificationTypes2() {
		...
		/// </summary>
		/// <returns></returns>
		public static RoslynClassificationTypes2 GetClassificationTypeInstance(IThemeClassificationTypeService themeClassificationTypeService) {
			if (classificationTypeInstance == null)
				Interlocked.CompareExchange(ref classificationTypeInstance, new RoslynClassificationTypes2(themeClassificationTypeService), null);
			return classificationTypeInstance;
		}
		static RoslynClassificationTypes2 classificationTypeInstance;

		RoslynClassificationTypes2(IThemeClassificationTypeService themeClassificationTypeService) {
