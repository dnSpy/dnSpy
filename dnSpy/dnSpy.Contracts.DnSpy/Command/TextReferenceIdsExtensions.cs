...
namespace dnSpy.Contracts.Command {
	...
	/// Extension methods
	/// </summary>
	static class TextReferenceIdsExtensions {
		/// <summary>
		/// Converts <paramref name="id"/> to a <see cref="CommandInfo"/>
		/// </summary>
		/// <param name="id">ID</param>
		/// <returns></returns>
		public static CommandInfo ToCommandInfo(this TextReferenceIds id) => new CommandInfo(CommandConstants.TextReferenceGroup, (int)id);
