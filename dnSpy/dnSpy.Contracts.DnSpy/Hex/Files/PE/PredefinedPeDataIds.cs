...
namespace dnSpy.Contracts.Hex.Files.PE {
	...
	public static class PredefinedPeDataIds {
		...
		/// <summary><see cref="PeOptionalHeader32Data"/></summary>
		public const string PeOptionalHeader32 = nameof(PeOptionalHeader32);

		/// <summary><see cref="PeOptionalHeader64Data"/></summary>
		public const string PeOptionalHeader64 = nameof(PeOptionalHeader64);
