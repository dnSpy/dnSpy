...
namespace dnSpy.Contracts.Hex.Intellisense {
	/// <summary>
	/// <see cref="HexIntellisenseSessionStack"/> service
	/// </summary>
	public abstract class HexIntellisenseSessionStackMapService {
		/// <summary>
		/// Constructor
		/// </summary>
		...
		/// <summary>
		/// Gets the <see cref="HexIntellisenseSessionStack"/> instance
		/// </summary>
