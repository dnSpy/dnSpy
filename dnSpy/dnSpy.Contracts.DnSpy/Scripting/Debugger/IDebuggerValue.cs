...
namespace dnSpy.Contracts.Scripting.Debugger {
	...
	/// process continues.
	/// </summary>
	public interface IDebuggerValue : IOutputWritable {
		/// <summary>
		...
		void Write(IOutputWriter output, ValueResult valueResult, TypeFormatFlags flags = TypeFormatFlags.Default);
		...
		/// <param name="output">Destination</param>
		/// <param name="flags">Flags</param>
		void Write(IOutputWriter output, TypeFormatFlags flags = TypeFormatFlags.Default);
		...
		/// <param name="type">Type</param>
		/// <param name="flags">Flags</param>
		void WriteType(IOutputWriter output, IDebuggerType type, TypeFormatFlags flags = TypeFormatFlags.Default);
		...
		/// <param name="cls">Class</param>
		/// <param name="flags">Flags</param>
		void WriteType(IOutputWriter output, IDebuggerClass cls, TypeFormatFlags flags = TypeFormatFlags.Default);
