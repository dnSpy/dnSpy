...
namespace dnSpy.Contracts.Scripting.Debugger {
	...
	/// A property
	/// </summary>
	public interface IDebuggerProperty : IOutputWritable {
		/// <summary>
		/// Gets the name
		/// </summary>
		string Name { get; }
		...
		void Write(IOutputWriter output, TypeFormatFlags flags = TypeFormatFlags.ShowParameterTypes | TypeFormatFlags.ShowReturnTypes | TypeFormatFlags.ShowNamespaces | TypeFormatFlags.ShowTypeKeywords);
