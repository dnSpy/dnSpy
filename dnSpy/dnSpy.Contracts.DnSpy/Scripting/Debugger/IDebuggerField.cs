...
namespace dnSpy.Contracts.Scripting.Debugger {
	...
	/// A field
	/// </summary>
	public interface IDebuggerField : IOutputWritable {
		/// <summary>
		/// Gets the name
		/// </summary>
		string Name { get; }
		...
		void Write(IOutputWriter output, TypeFormatFlags flags = TypeFormatFlags.ShowNamespaces | TypeFormatFlags.ShowTypeKeywords);
