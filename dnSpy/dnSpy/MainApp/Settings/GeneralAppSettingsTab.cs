...
namespace dnSpy.MainApp.Settings {
	...
	sealed class GeneralAppSettingsTabProvider : IAppSettingsTabProvider {
		...
		public IEnumerable<IAppSettingsTab> Create() {
			yield return new GeneralAppSettingsTab(themeService, windowsExplorerIntegrationService, documentTabServiceSettings, documentTreeViewSettings, documentServiceSettings, appSettings, messageBoxService);
		}
	}

	sealed class GeneralAppSettingsTab : ViewModelBase, IAppSettingsTab {
		...
		public GeneralAppSettingsTab(IThemeServiceImpl themeService, IWindowsExplorerIntegrationService windowsExplorerIntegrationService, IDocumentTabServiceSettings documentTabServiceSettings, DocumentTreeViewSettingsImpl documentTreeViewSettings, IDsDocumentServiceSettings documentServiceSettings, AppSettingsImpl appSettings, MessageBoxService messageBoxService) {
