...
namespace dnSpy.MainApp.Settings {
	...
	sealed class FontAppSettingsTabProvider : IAppSettingsTabProvider {
		readonly TextEditorSettingsImpl textEditorSettings;

		[ImportingConstructor]
		FontAppSettingsTabProvider(TextEditorSettingsImpl textEditorSettings) {
			this.textEditorSettings = textEditorSettings;
		}

		public IEnumerable<IAppSettingsTab> Create() {
			yield return new FontAppSettingsTab(textEditorSettings);
		}
	}

	sealed class FontAppSettingsTab : ViewModelBase, IAppSettingsTab {
		...
		public FontAppSettingsTab(TextEditorSettingsImpl textEditorSettings) {
