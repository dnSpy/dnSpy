...
namespace dnSpy.BackgroundImage {
	static class DefaultRawSettings {
		...
		public const int TotalGridRows = 0;
		public const int TotalGridColumns = 0;
		public const int GridRow = 0;
		public const int GridColumn = 0;
		public const int GridRowSpan = 1;
		public const int GridColumnSpan = 1;
