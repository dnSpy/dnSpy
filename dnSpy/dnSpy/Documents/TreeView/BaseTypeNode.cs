...
namespace dnSpy.Documents.TreeView {
	sealed class BaseTypeNode : DocumentTreeNodeData, IBaseTypeNode {
		...
		public override IEnumerable<ITreeNodeData> CreateChildren() {
			...
			if (td.BaseType != null)
				yield return new BaseTypeNode(Context.DocumentTreeView.DocumentTreeNodeGroups.GetGroup(DocumentTreeNodeGroupType.BaseTypeTreeNodeGroupBaseType), td.BaseType, true);
