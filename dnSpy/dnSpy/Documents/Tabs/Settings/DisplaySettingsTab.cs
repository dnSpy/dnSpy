...
namespace dnSpy.Documents.Tabs.Settings {
	...
	sealed class DisplayAppSettingsTabProvider : IAppSettingsTabProvider {
		...
		readonly DocumentTabServiceSettingsImpl documentTabServiceSettings;

		[ImportingConstructor]
		DisplayAppSettingsTabProvider(TextEditorSettingsImpl textEditorSettingsImpl, IEditorOptionsFactoryService editorOptionsFactoryService, DocumentTreeViewSettingsImpl documentTreeViewSettings, DocumentTabServiceSettingsImpl documentTabServiceSettings) {
		...
		public IEnumerable<IAppSettingsTab> Create() {
			yield return new DisplayAppSettingsTab(textEditorSettingsImpl, editorOptions, documentTreeViewSettings, documentTabServiceSettings);
		}
	}
	...
	sealed class DisplayAppSettingsTab : IAppSettingsTab {
		...
		readonly TextEditorSettingsImpl textEditorSettingsImpl;
		readonly IEditorOptions editorOptions;
		readonly DocumentTreeViewSettings documentTreeViewSettings;
		readonly DocumentTabServiceSettings documentTabServiceSettings;
		readonly DisplayAppSettingsVM displayAppSettingsVM;

		public DisplayAppSettingsTab(TextEditorSettingsImpl textEditorSettingsImpl, IEditorOptions editorOptions, DocumentTreeViewSettings documentTreeViewSettings, DocumentTabServiceSettings documentTabServiceSettings) {
			this.textEditorSettingsImpl = textEditorSettingsImpl;
			this.editorOptions = editorOptions;
			this.documentTreeViewSettings = documentTreeViewSettings;
			this.documentTabServiceSettings = documentTabServiceSettings;
			this.displayAppSettingsVM = new DisplayAppSettingsVM(new TextEditorSettingsVM(textEditorSettingsImpl, editorOptions), documentTreeViewSettings.Clone(), documentTabServiceSettings.Clone());
		}
		...
		public void OnClosed(bool saveSettings, IAppRefreshSettings appRefreshSettings) {
			...
			displayAppSettingsVM.DocumentTreeViewSettings.CopyTo(documentTreeViewSettings);
			displayAppSettingsVM.DocumentTabServiceSettings.CopyTo(documentTabServiceSettings);
		}
	}
	...
	sealed class TextEditorSettingsVM : ViewModelBase {
		...
		public void CopyTo(TextEditorSettingsImpl textEditorSettings, IEditorOptions editorOptions) {
			...
			editorOptions.SetOptionValue(DefaultDsTextViewOptions.ReferenceHighlightingId, HighlightReferences);
		}
	}
	...
	sealed class DisplayAppSettingsVM : ViewModelBase {
		...
		public DocumentTreeViewSettings DocumentTreeViewSettings { get; }
		public DocumentTabServiceSettings DocumentTabServiceSettings { get; }
		...
		public DisplayAppSettingsVM(TextEditorSettingsVM textEditorSettingsVM, DocumentTreeViewSettings documentTreeViewSettings, DocumentTabServiceSettings documentTabServiceSettings) {
