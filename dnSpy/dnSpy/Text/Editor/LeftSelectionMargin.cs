...
namespace dnSpy.Text.Editor {
	...
	sealed class LeftSelectionMarginProvider : IWpfTextViewMarginProvider {
		...
		LeftSelectionMarginProvider(IWpfTextViewMarginProviderCollectionCreator wpfTextViewMarginProviderCollectionCreator) {
			this.wpfTextViewMarginProviderCollectionCreator = wpfTextViewMarginProviderCollectionCreator;
		}

		public IWpfTextViewMargin CreateMargin(IWpfTextViewHost wpfTextViewHost, IWpfTextViewMargin marginContainer) =>
			new LeftSelectionMargin(wpfTextViewMarginProviderCollectionCreator, wpfTextViewHost);
	}

	sealed class LeftSelectionMargin : WpfTextViewContainerMargin {
		public LeftSelectionMargin(IWpfTextViewMarginProviderCollectionCreator wpfTextViewMarginProviderCollectionCreator, IWpfTextViewHost wpfTextViewHost)
