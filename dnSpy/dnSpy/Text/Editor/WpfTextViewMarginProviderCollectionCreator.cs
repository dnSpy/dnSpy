...
namespace dnSpy.Text.Editor {
	interface IWpfTextViewMarginProviderCollectionCreator {
	...
	[Export(typeof(IWpfTextViewMarginProviderCollectionCreator))]
	sealed class WpfTextViewMarginProviderCollectionCreator : IWpfTextViewMarginProviderCollectionCreator {
		readonly Lazy<IWpfTextViewMarginProvider, IWpfTextViewMarginMetadata>[] wpfTextViewMarginProviders;

		[ImportingConstructor]
		WpfTextViewMarginProviderCollectionCreator([ImportMany] IEnumerable<Lazy<IWpfTextViewMarginProvider, IWpfTextViewMarginMetadata>> wpfTextViewMarginProviders) {
