...
namespace dnSpy.Files.Tabs.DocViewer {
	...
	[ExportFileTabUIContextProvider(Order = TabConstants.ORDER_DOCUMENTVIEWERPROVIDER, UseStrongReference = true)]
	sealed class DocumentViewerProvider : IFileTabUIContextProvider {
