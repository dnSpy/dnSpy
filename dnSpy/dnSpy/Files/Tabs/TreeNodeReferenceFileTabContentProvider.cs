...
namespace dnSpy.Files.Tabs {
	[ExportReferenceFileTabContentProvider(Order = TabConstants.ORDER_CONTENTPROVIDER_TEXTREF)]
	sealed class TreeNodeReferenceFileTabContentProvider : IReferenceFileTabContentProvider {
		...
		TreeNodeReferenceFileTabContentProvider(DecompileFileTabContentFactory decompileFileTabContentFactory, IFileTabManagerSettings fileTabManagerSettings) {
