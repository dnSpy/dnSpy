...
namespace dnSpy.Files.Tabs {
	interface IFileTabContentFactoryManager {
	...
	sealed class FileTabContentFactoryManager : IFileTabContentFactoryManager {
		...
		FileTabContentFactoryManager([ImportMany] IEnumerable<Lazy<IFileTabContentFactory, IFileTabContentFactoryMetadata>> mefTabContentFactories) {
