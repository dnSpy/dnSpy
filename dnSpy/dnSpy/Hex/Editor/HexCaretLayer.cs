...
namespace dnSpy.Hex.Editor {
	sealed class HexCaretLayer : UIElement {
		...
		public HexCaretLayer(HexCaretImpl hexCaret, HexAdornmentLayer layer, VSTC.IClassificationFormatMap classificationFormatMap, VSTC.IClassificationTypeRegistryService classificationTypeRegistryService) {
			...
			activeCaretClassificationType = classificationTypeRegistryService.GetClassificationType(TC.ThemeClassificationTypeNames.HexCaret);
			inactiveCaretClassificationType = classificationTypeRegistryService.GetClassificationType(TC.ThemeClassificationTypeNames.HexInactiveCaret);
