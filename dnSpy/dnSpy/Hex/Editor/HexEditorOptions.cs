...
namespace dnSpy.Hex.Editor {
	sealed class HexEditorOptions : IEditorOptions {
		...
		public HexEditorOptions(HexEditorOptionsFactoryServiceImpl service, HexEditorOptions parent, IPropertyOwner scope) {
