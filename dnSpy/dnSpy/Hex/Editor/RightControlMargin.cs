...
namespace dnSpy.Hex.Editor {
	...
	[VSTE.MarginContainer(PredefinedHexMarginNames.Right)]
	[VSUTIL.Name(PredefinedHexMarginNames.RightControl)]
	[VSTE.TextViewRole(PredefinedHexViewRoles.Interactive)]
	sealed class RightControlMarginProvider : WpfHexViewMarginProvider {
