...
namespace dnSpy.Hex.Files {
	static class HexBufferFileUtils {
		public static KeyValuePair<HexBufferFile, ComplexData>? GetStructure(HexBufferFileService hexBufferFileService, HexPosition position) {
