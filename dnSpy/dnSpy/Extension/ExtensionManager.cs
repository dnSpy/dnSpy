...
namespace dnSpy.Extension {
	...
	[Export, Export(typeof(IExtensionManager))]
	sealed class ExtensionManager : IExtensionManager {
		...
		ExtensionManager([ImportMany] IEnumerable<Lazy<IAutoLoaded, IAutoLoadedMetadata>> mefAutoLoaded, [ImportMany] IEnumerable<Lazy<IExtension, IExtensionMetadata>> extensions) {
