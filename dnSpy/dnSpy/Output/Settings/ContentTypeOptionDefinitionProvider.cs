...
namespace dnSpy.Output.Settings {
	[ExportContentTypeOptionDefinitionProvider(PredefinedTextViewGroupNames.OutputWindow)]
	sealed class ContentTypeOptionDefinitionProvider : IContentTypeOptionDefinitionProvider {
		public IEnumerable<ContentTypeOptionDefinition> GetOptions() {
			...
			foreach (var contentType in contentTypes) {
				...
				yield return new OptionDefinition<BlockStructureLineKind>(contentType, DefaultDsTextViewOptions.BlockStructureLineKindId, BlockStructureLineKind.Dotted_2_2);
				...
				yield return new OptionDefinition<bool>(contentType, DefaultTextViewHostOptions.GlyphMarginId, false);
