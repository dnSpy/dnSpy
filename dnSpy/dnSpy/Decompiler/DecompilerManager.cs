...
namespace dnSpy.Decompiler {
	[Export(typeof(IDecompilerManager))]
	sealed class DecompilerManager : IDecompilerManager {
		readonly DecompilerManagerSettingsImpl decompilerManagerSettings;
		readonly IDecompiler[] decompilers;

		[ImportingConstructor]
		DecompilerManager(DecompilerManagerSettingsImpl decompilerManagerSettings, [ImportMany] IDecompiler[] languages, [ImportMany] IDecompilerCreator[] creators) {
			this.decompilerManagerSettings = decompilerManagerSettings;
			...
			this.decompiler = FindOrDefault(decompilerManagerSettings.LanguageGuid);
		...
		public IDecompiler Decompiler {
			...
			set {
				...
				if (decompiler != value) {
					decompiler = value;
					decompilerManagerSettings.LanguageGuid = value.UniqueGuid;
