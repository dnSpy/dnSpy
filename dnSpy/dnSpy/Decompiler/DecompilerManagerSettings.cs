...
namespace dnSpy.Decompiler {
	interface IDecompilerManagerSettings : INotifyPropertyChanged {
		Guid LanguageGuid { get; }
	}

	class DecompilerManagerSettings : ViewModelBase, IDecompilerManagerSettings {
	...
	[Export, Export(typeof(IDecompilerManagerSettings))]
	sealed class DecompilerManagerSettingsImpl : DecompilerManagerSettings {
		static readonly Guid SETTINGS_GUID = new Guid("6A7E565D-DC09-4AAE-A7C8-E86A835FCBFC");

		readonly ISettingsManager settingsManager;

		[ImportingConstructor]
		DecompilerManagerSettingsImpl(ISettingsManager settingsManager) {
