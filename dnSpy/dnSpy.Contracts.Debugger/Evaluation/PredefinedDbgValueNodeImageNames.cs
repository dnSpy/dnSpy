...
#pragma warning disable 1591 // Missing XML comment for publicly visible type or member
		...
		public const string GenericParameter = nameof(GenericParameter);
		...
		public const string StructInternal = nameof(StructInternal);
		public const string StructPrivate = nameof(StructPrivate);
		public const string StructProtected = nameof(StructProtected);
		public const string StructPublic = nameof(StructPublic);
		...
		public const string EnumerationValue = nameof(EnumerationValue);
		public const string EnumerationValuePrivate = nameof(EnumerationValuePrivate);
		public const string EnumerationValuePublic = nameof(EnumerationValuePublic);
		public const string EnumerationValueFamily = nameof(EnumerationValueFamily);
		public const string EnumerationValueAssembly = nameof(EnumerationValueAssembly);
		public const string EnumerationValueFamilyAndAssembly = nameof(EnumerationValueFamilyAndAssembly);
		public const string EnumerationValueFamilyOrAssembly = nameof(EnumerationValueFamilyOrAssembly);
		public const string EnumerationValueCompilerControlled = nameof(EnumerationValueCompilerControlled);
