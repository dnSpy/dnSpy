...
namespace dnSpy.Contracts.Debugger.Engine {
	...
	public abstract class DbgEngineBoundCodeBreakpoint {
		...
		public abstract void Update(UpdateOptions options, DbgModule module = null, ulong address = 0, DbgEngineBoundCodeBreakpointMessage message = default(DbgEngineBoundCodeBreakpointMessage));
	}
