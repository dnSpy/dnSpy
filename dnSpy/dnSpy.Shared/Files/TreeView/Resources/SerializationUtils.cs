	...
	public static class SerializationUtils {
		...
		public static string Deserialize(byte[] data, out object obj) {
			try {
				...
				obj = null;
				return string.Format(dnSpy_Shared_Resources.CouldNotDeserializeData, ex.Message);
			}
		}
		...
		public static string CreateObjectFromString(Type targetType, string typeAsString, out object obj) {
			...
			try {
				...
				return string.Format(dnSpy_Shared_Resources.CouldNotConvertFromString, ex.Message);
			}

			return string.Format(dnSpy_Shared_Resources.NoTypeConverter, targetType);
		}
