...
namespace dnSpy.Contracts.Debugger.DotNet.Metadata {
	...
	public abstract class DbgMetadataService {
		...
		/// <returns></returns>
		public abstract ModuleDef TryGetModule(DbgModule module, DbgLoadModuleOptions options = DbgLoadModuleOptions.None);
		...
		/// <param name="options">Load options</param>
		/// <returns></returns>
		public abstract ModuleDef TryGetModule(ModuleId moduleId, DbgLoadModuleOptions options = DbgLoadModuleOptions.None);
	}
