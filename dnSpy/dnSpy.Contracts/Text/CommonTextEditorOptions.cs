...
namespace dnSpy.Contracts.Text {
	...
	/// </summary>
	public sealed class CommonTextEditorOptions {
		/// <summary>
		...
		/// </summary>
		/// <returns></returns>
		public CommonTextEditorOptions Clone() => CopyTo(new CommonTextEditorOptions());

		CommonTextEditorOptions CopyTo(CommonTextEditorOptions other) {
