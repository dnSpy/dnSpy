...
namespace dnSpy.Contracts.Text.Editor.OptionsExtensionMethods {
	/// <summary>
	/// <see cref="DefaultDnSpyWpfViewOptions"/> extension methods
	/// </summary>
	public static class DefaultDnSpyWpfViewOptionsExtensions {
		/// <summary>
		...
		public static bool IsForceClearTypeIfNeededEnabled(this IEditorOptions options) {
			...
			return options.GetOptionValue(DefaultDnSpyWpfViewOptions.ForceClearTypeIfNeededId);
		}
	}
}
