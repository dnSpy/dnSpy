...
namespace dnSpy.Contracts.Files {
	/// <summary>
	/// Serialized module, identical to <c>SerializedDnModule</c>
	/// </summary>
	public struct SerializedDnSpyModule : IEquatable<SerializedDnSpyModule> {
		...
		/// <summary>
		/// Creates a <see cref="SerializedDnSpyModule"/> that was loaded from a file
		/// </summary>
		...
		/// <summary>
		/// Creates an in-memory <see cref="SerializedDnSpyModule"/>
		/// </summary>
		/// <param name="module">Module</param>
		/// <returns></returns>
		...
		/// <summary>
		/// Creates a <see cref="SerializedDnSpyModule"/>
		/// </summary>
		/// <param name="module">Module</param>
